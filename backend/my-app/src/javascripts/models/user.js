  ...
  return jwt.sign(
    {
      ...
      // *** the code in this method creates the token.  while authorization for admin endpoints is accomplished
      // without accessing the roles in the token, for the teacher endpoint it's needed (see the isTeacher function
      // in routes.js to see why), therefore to make the isTeacher function work correctly, replace the below line
      // with the one below it that is commented out:
      roles: this.roles,
